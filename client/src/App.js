...
function App() {
  const { state, addWorkout, addSet, updateSet, deleteSet } = useApplicationData();
    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route path="/log/show" element={<FormShow sets={state.sets} updateSet={updateSet} deleteSet={deleteSet}/>} />
